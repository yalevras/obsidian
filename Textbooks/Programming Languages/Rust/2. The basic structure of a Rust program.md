...
-> denotes return type for fn

```
fn add (a: i32, b: i32) -> i32 {
	a + b // The last expression is implicitly returned if it doesn't end with a semicolon
}

fn greet() {
	println!("Hello from the greet function!"); // Implicit () returned
}
